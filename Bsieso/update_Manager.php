...
<head>
    ...
    <title>Update Information of Manager</title>
        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form name="my-form"  action="Operations/updateManager.php" method="post">
							
							<div class="form-group row">
                                    <label for="m_id" class="col-md-4 col-form-label text-md-right">Manager ID</label>
                                    <div class="col-md-6">
                                        <input type="number" id="m_id" class="form-control" name="m_id">
                                    </div>
                                </div>

        ...
        <div class="container h-100">
            <div class="row h-100 align-items-center">
                <div class="col-12">
					...
					<a href="login_manager.php">  <img src="img/manager.png" height="130" width="130"> <br> <h5> Manager </h5></img></a>
					<br> <br> 
                    <a href="login_cust.php">  <img src="img/customer.png" height="100" width="100"> <br> <h5>Customer </h5></img></a>
